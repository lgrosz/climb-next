...
export default function CanvasArea() {
  ...
  const redraw = useCallback(() => {
    ...
    if (image && image.naturalWidth && world.background) {
      ctx.drawImage(image, 0, 0, image.naturalWidth, image.naturalHeight, world.background.position.x, world.background.position.y, world.background.size.width, world.background.size.height);
    }
